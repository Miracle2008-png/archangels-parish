...
const SACRAMENT_DATA: Record<string, {
  ...
  baptism: {
    ...
    process: [
      ...
      { step: 2, title: 'Complete Registration', description: 'Submit the completed form with all required documents at least two weeks before the intended date.' },
      { step: 3, title: 'Attend Preparation Class', description: 'Parents and godparents attend a mandatory preparation session offered by the parish.' },
      { step: 4, title: 'Baptism Ceremony', description: 'The Baptism is celebrated during Mass or at a separate ceremony on the scheduled date.' },
    ],
    contact: { name: '[PLACEHOLDER]', role: 'Baptism Coordinator', phone: '+234 806 569 0094', email: 'archangels_sat@yahoo.com' },
    faq: [
      { question: 'How often is Baptism celebrated?', answer: '[PLACEHOLDER — e.g., Baptism is celebrated on the first Sunday of each month after the 10:00 AM Mass.]' },
  ...
  marriage: {
    ...
    process: [
      ...
      { step: 2, title: 'Submit Documents', description: 'Provide all required documents for review by the parish office.' },
      { step: 3, title: 'Marriage Preparation Course', description: 'Attend the diocesan or parish Pre-Cana marriage preparation programme.' },
      { step: 4, title: 'Wedding Ceremony', description: 'Celebrate your wedding Mass with the blessing of the Church and your parish family.' },
    ],
    contact: { name: '[PLACEHOLDER]', role: 'Marriage Coordinator / Parish Priest', phone: '+234 806 569 0094', email: 'archangels_sat@yahoo.com' },
    faq: [
  ...
  funeral: {
    ...
    contact: { name: '[PLACEHOLDER]', role: 'Parish Priest / Parish Office', phone: '+234 806 569 0094', email: 'archangels_sat@yahoo.com' },
    faq: [
      { question: 'Is there an emergency number for anointing of the sick?', answer: '[PLACEHOLDER — Contact the parish office at +234 806 569 0094. For emergencies, a priest is available.]' },
